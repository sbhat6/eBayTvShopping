...
public class ItemPage extends TC_PurchaseTv {
	...
	public float getItemPrice() throws Exception { // Method to get the text of the item name, extract numbers part and
													// -convert to float data type and return the value to main method.
	...
	@AndroidFindBy(uiAutomator = "new UiSelector().resourceId(\"com.ebay.mobile:id/shipping_textview\")") // Element locator for item postage price
																											//-displayed in the item description.
	@CacheLookup // **Location strategy 'by UIAutomatorViewer is used here**
	AndroidElement itemPostageValue;

	public float getPostagePrice() throws Exception { // Method to get the text of the item price, extract numbers part
														// -and convert to float data type and return the value to main method.
	...
	public void addToCartAction() { // Method to get the text of the item postage price, extract numbers part and
										// -convert to float data type and return the value to main method.
