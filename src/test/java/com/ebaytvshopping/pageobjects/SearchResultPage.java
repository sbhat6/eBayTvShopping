...
public class SearchResultPage { // **Java OOP concept 'Constructors' is used here**
	...
	public void selectItem() { // Method to select one item title from the list of item titles based on a
								// -keyword.
